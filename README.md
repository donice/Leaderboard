...
> In this activity I will set up a JavaScript project for the Leaderboard list app.
...
```sh
  cd my-folder
  git clone https://github.com/donice/leaderboard.git
```
...
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/doniceubaru/)
